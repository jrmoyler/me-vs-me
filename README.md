...
A browser arcade fighter with 20 versions of Hataalii, five illustrated arenas, and 140 combat animations. Phaser 3 + Vite; keyboard, touch, and standard gamepad inputs.
...
Review the original [77 impact poses](docs/qa/all-77-move-peaks.jpg) and [five arenas](docs/qa/five-arenas.jpg). These are asset contact sheets, not browser screenshots.

## Verification boundaries

Automated checks cover original and new asset integrity, all 140 runtime attacks, meter costs, one-hit damage, tap buffering, pause, progression, bonus stages, and UI navigation. Runtime tests use a Phaser graphics stub; they exercise actual game scene logic but do not establish GPU performance or visual acceptance. See [QA notes](docs/qa/validation.md) for rendered-playtest status.
